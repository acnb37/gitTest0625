...
<body>
	...
	$(function(){
		if(result==""){
			...
			//opener.document.signUpForm : 부모창 내부 html 문서 내용 중 name 속성값이 signUpForm인 요소
			//signUpForm.id : name 속성값이 signUpForm인 요소 내부에 name이 id인 요소
		}
		else{
