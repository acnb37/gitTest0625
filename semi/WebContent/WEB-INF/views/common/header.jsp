...
<%--배포된 웹 어플리케이션의 최상위 주소를 간단히 얻어올 수 있도록
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="${contextPath}/borad/List?type=1">Board</a></li>

					
					<!-- 로그인을 했는지, 안했는지 구분하는 방법 ==sesstion에 loginMember 유무 -->
					<c:choose>
						<%-- 로그인이 되어있지 않을 때
						...
						<c:otherwise>
							<li class="nav-tiem active"><a class="nav-link" href="${contextPath}/member/myPage">${loginMember.memberName }</a></li>
							<li class="nav-tiem active"><a class="nav-link" href="${contextPath}/member/logout">Logout</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
				...
				<div class="modal-body">
					...
					<!-- onsubmit : form 태그 내부에서 엔터 또는 submit 타입의 버튼이 클릭 되었을 때를 나타내는 이벤트 리스너
						onsubmit = "return false;"
								->form 태그 내부에서 발생하는 submit 이벤트를 제거한다.
								기존이벤트 제거
					-->
